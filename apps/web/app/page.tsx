...
export default function Home() {
  return <><SiteHeader/><main>
    ...
    <section className="section shell"><div className="cta"><span className="kicker">Start focused</span><h2>Find one important workflow and prove the value.</h2><p>QgritAI begins with business evidence, not AI theatre.</p><ButtonLink href="mailto:hello@qgritai.com">Book a discovery conversation <ArrowRight size={17}/></ButtonLink></div></section>
  </main><Footer/></>;
}
